...
namespace Backend.Controllers
{
    ...
    {
        private readonly ICustomMatchService _matchService;
        private readonly IUserService _userService;
        private readonly ILogger<CustomMatchesController> _logger;

        public CustomMatchesController(ICustomMatchService matchService, IUserService userService, ILogger<CustomMatchesController> logger)
        {
